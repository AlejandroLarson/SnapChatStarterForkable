...
<h3 align="center">Global Chat Room</h3>

  <p align="center">
    Added RealTimeChat feature to the Snap starter code, MVP as a global chat room.
    <br />
...
Implemented RealTimeChat and Supabase, included a basic styling to show only the front part of an email as the username for users to talk to each other in a global chat room. 
